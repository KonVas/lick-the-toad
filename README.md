...
The system is developed as a cross platform application running on NodeJS, and JavaScript and various frameworks for sound/visuals, and [ml5](https://ml5js.org) for machine learning capabilities.
