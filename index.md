...
### User Interface
Each user is assigned a ball object, dragging it X and Y positions are stored as training data of the model of the neural network module.
![](https://github.com/KonVas/lick-the-toad/tree/main/images/user.gif)

The generated output can control real time sonfication algorithms which can run independently, but it may also be used as raw material for live coding and thusly expand on other performance possibilities and interactive media making it a highly flexible and versatile project. 
